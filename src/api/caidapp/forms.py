...
class MediaFileSetQueryForm(forms.Form):
    ...
    filter_show_videos = forms.BooleanField(label="Show videos", initial=True, required=True)
    filter_show_images = forms.BooleanField(label="Show images", initial=True, required=True)
