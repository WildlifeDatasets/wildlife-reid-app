...
def create_match_image_plotly(
    ...
    for i, ((_kp0, _kp1), color) in enumerate(
        ...
        fig.add_shape(
            ...
            y0=y0,
            x1=1,
            y1=y0,  # Line from point on left image to right edge of left subplot
            line=dict(color=color, width=2),
            xref="x",
            yref="y",
            row=1,
        ...
        fig.add_shape(
            ...
            y0=y1,
            x1=x1,
            y1=y1,  # Line from left edge of right subplot to point on right image
            line=dict(color=color, width=2),
            xref="x2",
            yref="y2",
            row=1,
